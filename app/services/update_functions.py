...
from app.services.supabase_client import *  # keep existing imports
from app.services.supabase_client import delete_file  # explicitly import delete_file
    ...
    if estacion_update.imagen:
        ...
        if "url" in resultado:
            ...
            if imagen_actual:
                ...
                if path_antiguo:
                    await delete_file(path_antiguo, SUPABASE_BUCKET_ESTACIONES) 
        else:
            print("Error al subir nueva imagen:", resultado.get("error"))
